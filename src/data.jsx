...
export const catalogData = [
  {
    id: 1,
    title: "WCAG 2.2 Essentials: Diseño Inclusivo, Dislexia y Neurodiversidad",
    category: "Desarrollo",
    price: 150,
    level: "Avanzado",
  ...
  {
    id: 2,
    title: "Arquitectura Web Accesible con React y WAI-ARIA",
    category: "Desarrollo",
    price: 180,
    level: "Avanzado",
  ...
  {
    id: 3,
    title: "Diseño de Interfaces Libres de Sobreestimulación Sensorial",
    category: "Diseño",
    price: 130,
    level: "Intermedio",
  ...
  {
    id: 4,
    title: "Especialista en Dislexia y Lectura Clara Digital",
    category: "Diseño",
    price: 140,
    level: "Intermedio",
  ...
  {
    id: 5,
    title: "Inclusión Laboral y Autonomía Cognitiva en Tecnología",
    category: "Desarrollo",
    price: 160,
    level: "Intermedio",
  ...
  {
    id: 6,
    title: "Inteligencia Emocional, Autonomía y Método Montessori Adaptado",
    category: "Diseño",
    price: 120,
    level: "Intermedio",
  ...
  // --- CURSOS INTEGRADOS DE LA SEGUNDA LANDING Y METODOLOGÍA ---
  {
    ...
    contenidos: [
      ...
      "TEMA 2. DISCAPACIDAD Y FAMILIA",
      "TEMA 3. LA DISCAPACIDAD EN EL ÁMBITO ESCOLAR",
      "TEMA 4. APOYO CONDUCTUAL POSITIVO COMO METODOLOGÍA DE INTERVENCIÓN EN DISCAPACIDAD",
      "TEMA 5. DISCAPACIDAD Y OCIO INCLUSIVO",
      "TEMA 6. TRÁNSITO DE LA VIDA ADULTA EN LAS PERSONAS CON DISCAPACIDAD",
      "TEMA 7. LA INCLUSIÓN EN EL ÁMBITO LABORAL"
    ],
    unidades: [
      "Entender la evolución de las respuestas sociales y modelos de trabajo en torno a las personas con discapacidad así como las características y necesidades de cada colectivo.",
      "Intervenir con la familia y comprender el papel que representan en la vida de la persona con discapacidad.",
      "Aplicar diferentes técnicas conductuales y cognitivas de apoyo para la intervención con personas de educación especial.",
      "Conocer las diferentes formas de trabajar en la escuela así como las posibles dificultades que pueden plantearse con los iguales y las formas de abordarlas.",
      "Organizar los espacios de ocio de las personas con discapacidad para fomentar su desarrollo personal de una forma inclusiva.",
      "Planificar el tránsito a la vida adulta a través de las diferentes áreas a desarrollar.",
      "Abordar la inclusión de las personas con discapacidad en el ámbito laboral de una forma planificada."
    ]
  },
  {
    id: 8,
    ...
    contenidos: [
      ...
      "TEMA 2. ESTIMULACIÓN COGNITIVA Y DIFICULTADES DE APRENDIZAJE",
      "TEMA 3. ESTRATEGIAS PARA MEJORAR LA CAPACIDAD DE APRENDER",
      "TEMA 4. INTERVENCIÓN EMOCIONAL EN LAS DIFICULTADES DE APRENDIZAJE"
    ],
    unidades: [
      "Conocer características diferenciales de los diferentes tipos de dificultades de aprendizaje.",
      "Conocer algunas de las técnicas de estimulación cognitiva utilizadas en la atención a las dificultades de aprendizaje.",
      "Conocer algunas técnicas y herramientas de aprendizaje utilizadas en la atención a las dificultades de aprendizaje.",
      "Conocer factores socioemocionales que pueden incidir en el desarrollo y mantenimiento de las dificultades de aprendizaje."
    ]
  },
  {
    id: 9,
    title: "Método Montessori (0 a 6 años)",
    category: "Diseño",
    price: 130,
    level: "Básico",
    ...
    contenidos: [
      "TEMA 0. VÍDEO DE PRESENTACIÓN DEL CURSO",
      "TEMA 1. EL MÉTODO MONTESSORI",
      "TEMA 2. APLICACIÓN DEL MÉTODO MONTESSORI: DE 0 A 3 AÑOS",
      "TEMA 3. APLICACIÓN DEL MÉTODO MONTESSORI: DE 3 A 6 AÑOS",
      "TEMA 4. BANCO DE ACTIVIDADES PRÁCTICAS"
    ],
    unidades: [
      "Conocer los principios pedagógicos y metodológicos del método educativo Montessori.",
...
export const accessibilityProfiles = [
  { profile: "Ceguera / Baja Visión", action: "Compatibilidad con lectores de pantalla, alto contraste y opciones de ampliación tipográfica." },
  { profile: "Dislexia", action: "Tipografías adaptadas, mayor espaciado entre líneas y colores de fondo de baja fatiga visual." },
  { profile: "TDAH", action: "Reducción de elementos distractores, enfoque guiado y diseño modular estructurado." },
  { profile: "Autismo y Neurodivergencias", action: "Previsibilidad en la navegación, ausencia de estímulos visuales agresivos y claridad en las instrucciones." }
];
